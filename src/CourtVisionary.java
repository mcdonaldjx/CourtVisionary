...
public class CourtVisionary {
	...
	public static void main(String[] args) throws Exception{
		...
		int currDay = Integer.parseInt(date.substring(3,date.lastIndexOf(" ")));
       ...
       //Creating teams first
        request = new Request.Builder()
        	...
        	.get()
        	.addHeader("x-rapidapi-key", "e4e01a94dbmsh4d44bc49f9c1d21p129893jsnfa4be8123e01")
	...
	public static boolean listContains(Player p1, List<Player> listP) {
		for(Player p : listP) {
			if(p1.id == p.id) {
				return true;
			}
